...
function SiteHeader(props) {
    return (
        <header className="items-center bg-white flex flex-col flex-nowrap pt-3 sticky top-0 z-30 border-gray_light">
            <nav className="flex mx-auto pb-2 px-3 w-full max-w-screen-xl">
                <Link href="/" className="p-0 flex items-center text-xl">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512"
                        className="w-8 fill-purple_dark"
                    >
                    ...
                    <span className="hidden sm:block ml-0.5 font-extrabold">
                        IniTech
                    </span>
                </Link>

                <div class="rounded-sm border-none inline-block text-sm font-normal ml-4 mr-10 py-1 px-2 relative hover:text-gray_med">
                    <button class="flex border-none p-0 text-sm">
                        {/* Need to apply this by script: svg.rotated {transform: rotate(-90deg); */}
                        <div class="inline-block text-sm">v.3.2.1</div>
                        <span class="w-4 flex">
                            <svg
                                id="apis-drop-down-expander"
                                viewBox="0 0 70 70"
                                class="h-5 mb-0.5 origin-center rotate-90 w-4"
                            >
                                <path
                                    fill="transparent"
                ...
                <Link
                    href="/blog/blog"
                    className="rounded-2xl hidden ml-0.5 border py-1 px-2 lg:flex"
                >
                    <span className="text-sm font-normal">
                        sdfdsit amet consectetur. Lorem ipsum
                    </span>
                    <div class="cursor-pointer ml-1 flex">
                ...
                <div class="lg:flex item-center ml-auto">
                    <nav class="hidden lg:flex items-center">
                        <Link
                            href="/docs/docs"
                            className="bg-transparent border-0 text-sm my-0 mr-4"
                        >
                            Documentation
                        </Link>
                        <Link
                            href="/blog/blog"
                            className="bg-transparent border-0 text-sm my-0 ml-4 mr-8"
                        >
                            Blog
                        </Link>
                    </nav>
                    <nav class="hidden lg:flex pl-8 border-l">
                        <button class="flex bg-transparent border-0 p-0">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                className="w-6 fill-codeblockheader_dark"
                            >
                        ...
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 496 512"
                                className="w-6 fill-codeblockheader_dark ml-8"
                            >
                ...
                <div class="lg:hidden flex ml-auto">
                    <button class="bg-transparent border-0 p-0 lg:hidden flex">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512"
                            className="w-8 h-5 fill-codeblockheader_dark mt-0.5"
                        >
