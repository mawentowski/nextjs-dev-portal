            ...
            <nav className="flex mx-auto py-3 px-6 w-full max-w-screen-xl ">
                <Link href="/" className="p-0 flex items-center text-xl">
                    <svg
                        ...
                        viewBox="0 0 640 512"
                        className="w-8 fill-blueextradark"
                    >
                    ...
                    <span className="hidden sm:block ml-0.5 font-extrabold text-blueextradark">
                        IniTech
                    </span>
                </Link>

                <div class="rounded-3xl border-none inline-block text-sm font-normal ml-4 mr-10 py-1 px-2 relative bg-graylight hover:bg-graymedium xs:ml-0">
                    <button class="flex border-none p-0 text-sm text-graydark items-center">
                    ...
                    <nav class="hidden lg:flex pl-8 border-l border-l-graymedium">
                        <ButtonPlain className="flex">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                className="w-6 fill-bluedark opacity-50 hover:opacity-80"
                            >
                        ...
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 496 512"
                                className="w-6 ml-8 fill-graydark opacity-50 hover:opacity-80"
                            >
                ...
                <div class="lg:hidden flex ml-auto items-center">
                    <ButtonPlain className="lg:hidden flex">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512"
                            className="w-8 h-5 fill-graydark opacity-70"
                        >
